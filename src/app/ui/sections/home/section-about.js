...
export default function SectionAbout({}) {
  return (
    <Container className={"py-10"}>
      <section className="p-10 space-y-5 rounded-xl bg-gradient-to-bl from-creajovem-green-500/30 to-creajovem-blue-100/50 dark:to-creajovem-blue-900 to-70%">
        <div className="space-y-3">
          <Text_head_2
            className={
              "font-bold text-creajovem-blue-500 dark:text-creajovem-green-500"
            }
          >
            O programa
          </Text_head_2>
          ...
          <Text_link href={"#"} className={"flex items-center gap-3"}>
